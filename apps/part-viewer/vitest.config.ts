...
export default defineConfig({
  ...
  test: {
    // The UI package and its panel library live in node_modules and would
    // otherwise be loaded outside Vite's resolution, which is where the second
    // React copy gets in.
    server: { deps: { inline: ['@toolpath/ui', 'react-resizable-panels'] } },
