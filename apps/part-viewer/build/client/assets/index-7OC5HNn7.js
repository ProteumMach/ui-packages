      ...
      (function (l) {
            ...
            e: for (var u = 0, r = e.length, P = r >>> 1; u < P; ) {
              ...
              if (0 > m(I, n))
                o < r && 0 > m(C, I)
                  ? ((e[u] = C), (e[o] = n), (u = o))
                  : ((e[u] = I), (e[T] = n), (u = T))
              else if (o < r && 0 > m(C, n)) ((e[u] = C), (e[o] = n), (u = o))
              else break e
            }
          }
          return a
        ...
        function w(e) {
          for (var a = i(c); a !== null; ) {
            ...
            else if (a.startTime <= e) (k(c), (a.sortIndex = a.expirationTime), S(s, a))
            else break
            a = i(c)
          }
        }
        function R(e) {
          if (((y = !1), w(e), !d))
            if (i(s) !== null) ((d = !0), b || ((b = !0), v()))
            else {
              var a = i(c)
              a !== null && D(R, a.startTime - e)
            }
        }
        var b = !1,
          _ = -1,
        ...
        function H() {
          if (((q = !1), b)) {
            ...
            try {
              e: {
                ;((d = !1), y && ((y = !1), Y(_), (_ = -1)), (g = !0))
                var n = t
                try {
                  n: {
                    for (w(e), f = i(s); f !== null && !(f.expirationTime > e && z()); ) {
                      var u = f.callback
          ...
          (l.unstable_scheduleCallback = function (e, a, n) {
            ...
            return (
              ...
              n > u
                ? ((e.sortIndex = n),
                  S(c, e),
                  i(s) === null && e === i(c) && (y ? (Y(_), (_ = -1)) : (y = !0), D(R, n - u)))
                : ((e.sortIndex = r), S(s, e), d || g || ((d = !0), b || ((b = !0), v()))),
              e
            )
          }),
...
var G
function X() {
  return (G || ((G = 1), (U.exports = W())), U.exports)
}
export { X as r }
