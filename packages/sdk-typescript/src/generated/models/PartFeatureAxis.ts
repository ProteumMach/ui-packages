 ...
 */
export function instanceOfPartFeatureAxis(value: object): value is PartFeatureAxis {
...
export function PartFeatureAxisFromJSON(json: any): PartFeatureAxis {
  return PartFeatureAxisFromJSONTyped(json, false)
}

export function PartFeatureAxisFromJSONTyped(
  json: any,
...
export function PartFeatureAxisToJSON(json: any): PartFeatureAxis {
  return PartFeatureAxisToJSONTyped(json, false)
}

export function PartFeatureAxisToJSONTyped(
  value?: PartFeatureAxis | null,
