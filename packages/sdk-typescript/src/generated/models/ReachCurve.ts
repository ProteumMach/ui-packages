 ...
 */
export function instanceOfReachCurve(value: object): value is ReachCurve {
  if (!('horizontalOffset' in value) || value['horizontalOffset'] === undefined) return false
  if (!('verticalOffset' in value) || value['verticalOffset'] === undefined) return false
  return true
}

export function ReachCurveFromJSON(json: any): ReachCurve {
  return ReachCurveFromJSONTyped(json, false)
}

export function ReachCurveFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReachCurve {
  if (json == null) {
    return json
  }
  return {
...
export function ReachCurveToJSON(json: any): ReachCurve {
  return ReachCurveToJSONTyped(json, false)
}

export function ReachCurveToJSONTyped(
  value?: ReachCurve | null,
