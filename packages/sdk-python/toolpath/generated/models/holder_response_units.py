...
T = TypeVar("T", bound="HolderResponseUnits")


@_attrs_define
class HolderResponseUnits:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        holder_response_units = cls(
            length=length,
            angle=angle,
        )

        holder_response_units.additional_properties = d
        return holder_response_units
