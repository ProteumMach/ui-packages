...
T = TypeVar("T", bound="TurningAxisLocation")


@_attrs_define
class TurningAxisLocation:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        turning_axis_location = cls(
            x=x,
            y=y,
            z=z,
        )

        turning_axis_location.additional_properties = d
        return turning_axis_location
