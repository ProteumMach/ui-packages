...
T = TypeVar("T", bound="CreateHolderResponse")


@_attrs_define
class CreateHolderResponse:
    """
    Attributes:
        holder_id (UUID): Identifier of the newly created holder.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_holder_response.additional_properties = d
        return create_holder_response
