...
T = TypeVar("T", bound="DirectionZBoundsDirection")


@_attrs_define
class DirectionZBoundsDirection:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        direction_z_bounds_direction = cls(
            x=x,
            y=y,
            z=z,
        )

        direction_z_bounds_direction.additional_properties = d
        return direction_z_bounds_direction
